...
// ✅✅✅ **بداية الإضافة: دالة مساعدة لتهيئة التاريخ** ✅✅✅
...
export default function Sales() {
  ...
  const [filters, setFilters] = useState({
    ...
    productId: "",
    page: 1,
    from: "", // ✅ إضافة فلتر التاريخ
    to: "",   // ✅ إضافة فلتر التاريخ
  });
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setError("");
      try {
        // ✅ تمرير فلاتر التاريخ إلى الـ API
        const params = { 
            ...filters, 
            stage: "sales", 
            limit: PAGE_SIZE, 
  ...
  return (
    <div className="sales-page">
      ...
      <div className="filters">
        ...
        />
        {/* ✅✅✅ **بداية إضافة حقول وأزرار التاريخ** ✅✅✅ */}
        <div className="field">
            <span>From Date</span>
        ...
        {/* ✅✅✅ **نهاية إضافة حقول وأزرار التاريخ** ✅✅✅ */}
      </div>
        ...
        <table className="table">
          ...
          <tbody>
            {loading ? (
                ...
                <tr><td colSpan={7} className="center error">{error}</td></tr>
            ) : deals.length === 0 ? (
                <tr><td colSpan={7} className="center">No deals found for the selected period.</td></tr>
            ) : (
                deals.map((deal) => (
                <tr key={deal._id}>
                    <td>{deal.name || "-"}</td>
